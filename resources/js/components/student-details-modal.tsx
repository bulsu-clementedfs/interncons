...
export default function StudentDetailsModal({
    ...
    const handleApprove = () => {
        if (!student?.best_match?.internship) {
            alert('No internship match found for this student');
            return;
        }
        
        // Validate the data before sending
        if (!student.best_match.internship.id || !student.best_match.compatibility_score) {
            alert('Invalid internship or compatibility score data');
            return;
        }
