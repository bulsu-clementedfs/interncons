...
import { Plus, MoreHorizontal, Edit, Archive, Eye } from 'lucide-react';
...
export default function HTEManagement({ htes }: Props) {
    ...
    const handleArchive = (hte: HTE) => {
        if (confirm('Are you sure you want to archive this HTE account?')) {
            ...
            window.location.href = route('admin.hte.archive', hte.id);
        }
    };
                    ...
                    <CardContent>
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody>
                                    {htes.map((hte) => (
                                        <tr key={hte.id} className="border-b border-gray-100 hover:bg-gray-50">
