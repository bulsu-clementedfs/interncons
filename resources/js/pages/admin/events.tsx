...
import { FileTextIcon, PlusIcon, EditIcon, ArchiveIcon, RotateCcwIcon, FilterIcon, XIcon } from 'lucide-react';
...
export default function EventsPage({ questions, categories }: EventsPageProps) {
    ...
    const filteredQuestions = questions.filter(question => {
        const matchesArchive = showArchived ? !question.is_active : question.is_active;
        const matchesCategory = !selectedCategory || question.subcategory.category.id.toString() === selectedCategory;
        const matchesSubcategory = !selectedSubcategory || question.subcategory_id.toString() === selectedSubcategory;
        
        return matchesArchive && matchesCategory && matchesSubcategory;
    });
